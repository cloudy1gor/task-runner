...
!function (e, t) {
    ...
    n ? (G.set(e, t, !1), b.event.add(e, t, {
      ...
      handler: function handler(e) {
        ...
        if (1 & e.isTrigger && this[t]) {
          if (a.length) (b.event.special[t] || {}).delegateType && e.stopPropagation();else if (a = i.call(arguments), G.set(this, t, a), r = n(this, t), this[t](), a !== (o = G.get(this, t)) || r ? G.set(this, t, !1) : o = {}, a !== o) return e.stopImmediatePropagation(), e.preventDefault(), o.value;
  ...
  b.event = {
    ...
    add: function add(e, t, n, r, i) {
      ...
      if (X(e)) for (n.handler && (n = (o = n).handler, i = o.selector), i && b.find.matchesSelector(ne, i), n.guid || (n.guid = b.guid++), (u = v.events) || (u = v.events = Object.create(null)), (a = v.handle) || (a = v.handle = function (t) {
        ...
        d = g = (s = Te.exec(t[l]) || [])[1], h = (s[2] || "").split(".").sort(), d && (f = b.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, f = b.event.special[d] || {}, c = b.extend({
          type: d,
          origType: g,
          data: r,
          handler: n,
  ...
  function Re(e, t, n, r) {
    ...
    if (p && (a = (i = xe(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === i.childNodes.length && (i = a), a || r)) {
      ...
      if (u) for (c = s[s.length - 1].ownerDocument, b.map(s, He), f = 0; f < u; f++) {
  ...
  b.extend({
    ...
    css: function css(e, t, n, r) {
      var i,
          ...
          a,
          s = U(t);
      return Ye.test(t) || (t = Ve(s)), (a = b.cssHooks[t] || b.cssHooks[s]) && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = $e(e, t, r)), "normal" === i && t in Je && (i = Je[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i;
    }
  }), b.each(["height", "width"], function (e, t) {
    b.cssHooks[t] = {
      get: function get(e, n, r) {
        if (n) return !Ge.test(b.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? et(e, t, r) : Fe(e, Qe, function () {
          return et(e, t, r);
        });
      },
  ...
  b.fn.extend({
    ...
    toggleClass: function toggleClass(e, t) {
      ...
      return "boolean" == typeof t && r ? t ? this.addClass(e) : this.removeClass(e) : h(e) ? this.each(function (n) {
        ...
        var t, i, o, a;
        if (r) for (i = 0, o = b(this), a = yt(e); t = a[i++];) {
  ...
  b.extend(b.event, {
    trigger: function trigger(t, n, r, i) {
      ...
      if (a = d = s = r = r || v, 3 !== r.nodeType && 8 !== r.nodeType && !xt.test(m + b.event.triggered) && (m.indexOf(".") > -1 && (x = m.split("."), m = x.shift(), x.sort()), l = m.indexOf(":") < 0 && "on" + m, (t = t[b.expando] ? t : new b.Event(m, "object" == _typeof(t) && t)).isTrigger = i ? 2 : 3, t.namespace = x.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + x.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : b.makeArray(n, [t]), p = b.event.special[m] || {}, i || !p.trigger || !1 !== p.trigger.apply(r, n))) {
        if (!i && !p.noBubble && !g(r)) {
  ...
  b.ajaxSetup({
    ...
    var r,
        ...
        a = this,
        s = e.indexOf(" ");
    return s > -1 && (r = gt(e.slice(s)), e = e.slice(0, s)), h(t) ? (n = t, t = void 0) : t && "object" == _typeof(t) && (i = "POST"), a.length > 0 && b.ajax({
      url: e,
      type: i || "GET",
      dataType: "html",
      data: t
...
!function (e, t) {
  ...
  var v = function v(e, n, o) {
    var i = !0,
        a = !0;
    if ("function" != typeof e) throw new TypeError(t);
    return p(o) && (i = "leading" in o ? !!o.leading : i, a = "trailing" in o ? !!o.trailing : a), function (e, n, o) {
      var i,
          a,
          r,
          c,
      ...
      h = /^0o[0-7]+$/i,
      k = parseInt,
      x = "object" == _typeof(e) && e && e.Object === Object && e,
